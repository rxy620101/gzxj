  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryParams" size="small" :inline="true" v-show="showSearch">
      <el-form-item label="奖项类别" prop="parentId">
        <el-select v-model="queryParams.parentId" placeholder="请输入奖项类别" clearable>
          <el-option
            v-for="dict in awardTypeOptions"
            :key="dict.settingId"
            :label="dict.awardName"
            :value="dict.settingId"
          />
        </el-select>
      </el-form-item>
      <el-form-item label="具体奖项" prop="status">
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          <el-col :span="24" v-if="form.parentId !== 0">
            <el-form-item label="奖项类别" prop="parentId">
              <treeselect v-model="form.parentId" :options="prizeTypeOptions" :normalizer="normalizer"
                          placeholder="选择奖项类别"/>
            </el-form-item>
          </el-col>
        </el-row>
